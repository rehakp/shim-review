...
-------------------------------------------------------------------------------
We haven't shipped Shim along with GRUB2 yet. Our GRUB does not allow for booting anything except the Linux kernel included in the distro and the Windows kernel.
